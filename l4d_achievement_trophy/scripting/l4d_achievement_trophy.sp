...
ConVar g_hCvarMPGameMode, g_hCvarAllow, g_hCvarModes, g_hCvarModesOff, g_hCvarModesTog, g_hCvarEffects, g_hCvarSound, g_hCvarThird, g_hCvarTime, g_hCvarWait,hCvar_Precache;
...
public void OnPluginStart()
{
	...
	hCvar_Precache 		= CreateConVar("l4d_trophy_precache",	"c1m3_mall",	"Prevent pre-caching models on these maps, separate by commas (no spaces). Enabling plugin on these maps will crash the server.", FCVAR_NOTIFY );
